...
/*    parallaxContainer.findViewById(R.id.button_fan1).setOnClickListener(this);
    ...
    parallaxContainer.findViewById(R.id.button_fan1).setOnTouchListener(this);
    parallaxContainer.findViewById(R.id.button_fan2).setOnTouchListener(this);
    parallaxContainer.findViewById(R.id.button_fan3).setOnTouchListener(this);

    parallaxContainer.findViewById(R.id.button_son1).setOnTouchListener(this);
    parallaxContainer.findViewById(R.id.button_son2).setOnTouchListener(this);
    parallaxContainer.findViewById(R.id.button_son3).setOnTouchListener(this);
      ...
      case MotionEvent.ACTION_DOWN: {
        switch ((String)v.getTag()) {
          case FAN:
            ...
            break;
          case SON:
            v.setBackgroundResource(R.drawable.erduo2);
            playMusic();
            break;
        }
        break;
      ...
      case MotionEvent.ACTION_UP: {
        switch ((String)v.getTag()) {
          case FAN:
            ...
            break;
          case SON:
            v.setBackgroundResource(R.drawable.erduo);
            break;
        }
        break;
      }
